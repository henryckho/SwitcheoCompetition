...
var WalletService = /** @class */ (function () {
    ...
    WalletService.prototype.login = function (privateKey) {
        this.loggedInWallet = null;
        if (privateKey) {
            try {
